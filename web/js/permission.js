...
var permission = {
    ...
    checkUncheckCheckbox: function (id) {
        if ($("#chk" + id).is(':checked')) {
            $('#module' + id + ' .checkbox input:checkbox').prop('checked', true);
        }
        else {
            $('#module' + id + ' .checkbox input:checkbox').prop('checked', false);
        }
    ...
    checkUncheckItemCheckbox: function (moduleId, id) {
        ...
        if ($("#itemChk" + id).is(':checked')) {
            if (allcheckboxLen == checkedLen) {
                $("#chk" + moduleId).prop('checked', true);
            }
            ...
            if (allcheckboxLen == checkedLen) {
                ...
                $("#chk" + moduleId).prop('checked', false);
            }
        }
        var l = $('.chk [name="item_list[]"]:checked').length;
        if (l < 1) {
