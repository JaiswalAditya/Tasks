...
/**
 * AngularDeveloperSearch represents the model behind the search form of `app\models\AngularDeveloper`.
 */
class AngularDeveloperSearch extends AngularDeveloper
{
    /**
     * {@inheritdoc}
     */
