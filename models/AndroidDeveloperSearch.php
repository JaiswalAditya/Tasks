...
/**
 * AndroidDeveloperSearch represents the model behind the search form of `app\models\AndroidDeveloper`.
 */
class AndroidDeveloperSearch extends AndroidDeveloper
{
    /**
     * {@inheritdoc}
     */
