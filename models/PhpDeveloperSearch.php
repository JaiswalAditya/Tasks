...
/**
 * PhpDeveloperSearch represents the model behind the search form of `app\models\PhpDeveloper`.
 */
class PhpDeveloperSearch extends PhpDeveloper
{
    /**
     * {@inheritdoc}
     */
